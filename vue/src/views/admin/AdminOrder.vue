      ...
      <table>
        ...
        <tbody>
          <tr v-for="order in orders" :key="order.orderNo">
            ...
            <td>
              <button @click="viewOrderDetail(order.orderNo)" class="view-btn">查看详情</button>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <div class="modal-content">
        ...
        <div v-if="orderDetail" class="order-detail">
          <div class="detail-section">
            ...
            <div class="detail-item">
              <label>重量：</label>
              <span>{{ orderDetail.weight }}kg</span>
            </div>
            <div class="detail-item">
              <label>运费：</label>
              <span>{{ orderDetail.fee }}元</span>
            </div>
          </div>
          ...
          <div class="detail-section">
            ...
            <div class="detail-item">
              <label>姓名：</label>
              <span>{{ orderDetail.sender?.name }}</span>
            </div>
            <div class="detail-item">
              <label>电话：</label>
              <span>{{ orderDetail.sender?.phone }}</span>
            </div>
            <div class="detail-item">
              <label>地址：</label>
...
const viewOrderDetail = async (orderNo) => {
  try {
    const res = await axios.get(`/api/admin/order/detail?orderNo=${orderNo}`)
